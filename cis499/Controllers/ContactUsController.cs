...
namespace cis499.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Message,Email")] ContactU contactU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Message,Email")] ContactU contactU)
        {
            if (id != contactU.Id)
            {
                return NotFound();
